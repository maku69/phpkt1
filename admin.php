            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                    <ul class="navbar-nav mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a href="https://liivakast.hkhk.edu.ee/~mpilv/bs5/KT/Tooted.html" class="nav-link text-dark">Tehtud Ț̦d</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="https://liivakast.hkhk.edu.ee/~mpilv/phpkt/admin2.php" class="btn btn-primary" class="nav-link active text-dark" aria-current="page" >Admin</a>
                        </li>
                    </ul>
                </div>
            </div>
